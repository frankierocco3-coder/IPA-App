...
Sonnet review: 1 to 45 approved in Neutral American as of 2026-09-25,
an unbroken run, every one line-aligned, so Side by Side pairs
numbered line to numbered line across all 45. Batches were five at a
time until the whole catalogue was audited; batch 5 was TWENTY-FIVE,
which the audit made possible. 12, 15, 18, 27, 29, 30 and 40 carry
the complete set (Plain Meaning + paired Side by Side + In Today's
Voice). Pilots 18 and 29 are the first pilot transpositions a learner
can see. ALL 154 nam texts pair line for line since 2026-09-25.
