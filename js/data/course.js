...
export const COURSE = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'nam-v1', title: 'The vowels · short & central', accent: 'nam', guide: 'Every short and central vowel of Neutral American, one by one. /ɪ/ (kit), /e/ (dress), /æ/ (trap — and BATH words too), /ʌ/ (strut), /ʊ/ (foot), /ɑ/ (lot, open and unrounded), and the schwa /ə/ that fills every unstressed syllable. Open the diagram on each to see where your tongue sits.', phonemes: ['ɪ', 'e', 'æ', 'ʌ', 'ʊ', 'ɑ', 'ə'], types: ['soundToSymbol', 'symbolToWord', 'description'] },
