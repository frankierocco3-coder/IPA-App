...
export const RECASTS = {
  ...
  29: {
    ...
    recasts: {
      nam: `When my luck’s gone and nobody’s calling,\nI sit alone and feel like a complete outcast,\nyelling at a sky that isn’t listening,\nlooking at myself and cursing my luck —\nwishing I were someone richer in hope,\nbuilt like him, with his friends around him,\nwanting this man’s art and that man’s reach,\nleast contented with what I enjoy most.\nYet right in the middle of despising myself,\nI happen to think of you — and then my whole state,\nlike a lark getting up at daybreak\noff the sullen ground, sings hymns at heaven’s gate.\nRemembering the love you give me brings such wealth\nthat I wouldn’t trade my life for a king’s.`,
      ssbe: `When it’s all gone wrong and nobody wants to know,\nI sit about on my own feeling like a proper outcast,\nhaving a go at a sky that couldn’t care less,\nlooking at myself and absolutely hating it —\nwishing I had his luck, that one’s prospects,\nbuilt like him, with his mates around him,\nafter this man’s talent and that man’s range,\nleast content with the things I love most.\nAnd then, mid-wallow, right at my worst,\nI happen to think of you — and my whole state,\nlike a lark going up at dawn\noff the dark ground, sings hymns at heaven’s gate.\nWhat your love’s worth, once I remember it,\nI wouldn’t swap places with a king.`,
      aus: `When my luck’s shot and no one’s picking up,\nI sit out here on my own like a proper outsider,\nbunging it on at a sky that isn’t listening,\ncopping a look at myself and hating it —\njealous of his chances, her looks,\nbuilt like him, with his mates round him,\nafter this bloke’s talent and that one’s run of it,\nand even the stuff I love feels flat.\nThen right in the middle of the sulk,\nyou come to mind — and my whole state,\nlike a lark off the dark paddock at first light,\ngoes belting it out at heaven’s gate.\nRemembering what your love’s worth,\nI wouldn’t swap spots with a king. Not a chance.`,
    },
  },
  73: {
