...
export const ACTING_LESSONS = [
  ...
  { id: 'ac-facts', module: 'work', order: 3,
    ...
    body: [
      { p: 'A fact is something the text establishes. An assumption is something you have supplied, often without noticing. An unknown is something the text genuinely leaves open — and those are gifts, not gaps.' },
  ...
  { id: 'ac-who', module: 'text', order: 2,
    ...
    body: [
      { p: 'Speech is aimed. Who the character is speaking to — their history together, the power between them, what they already know, what they will not say — shapes word choice, timing, how much is left unsaid and what is risked.' },
  ...
  { id: 'ac-moment', module: 'listening', order: 3,
    ...
    body: [
      ...
      { p: 'This is not an argument against rehearsal — the opposite. Thorough preparation is what makes moment-to-moment work possible, because the things that must be reliable are reliable, leaving the live things free.' },
    ] },
  ...
  { id: 'ac-repetition', module: 'listening', order: 5,
    ...
    body: [
      { p: 'Repetition is how the work becomes reliable — and it is also how a scene dies, if what is repeated is a performance rather than a pursuit. The difference is what you are repeating: the circumstances, the objective and the listening, or a remembered set of line-readings.' },
