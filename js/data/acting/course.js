...
export const ACTING_LESSONS = [
  ...
  { id: 'ac-inside', module: 'character', order: 1,
    title: 'Looking Inside, Not Out',
    requiredReviewer: 'acting-professional',
    objective: 'Start from the people already in you.',
    orientation: 'Observation is usually taught as looking outward. This module looks the other way.',
    reflection: 'Who has spoken up in you before, unprompted? A voice you can do without preparing.',
    body: [
      { p: 'You already carry a cast. Improvise out loud with no plan, doing a voice for the fun of it, then listen back. You will often find a monologue you never intended, spoken by someone who was waiting for the chance.' },
      { p: 'This works because you have been collecting people your whole life. Some you met. Some you watched in films. The part of you that makes behavior does not care which is which.' },
      { p: 'A character is not an object you finish. It is a person you get breathing. Keep experimenting until one stands up on its own.' },
    ] },
  { id: 'ac-room', module: 'character', order: 2,
    title: 'The Empty Room',
    requiredReviewer: 'acting-professional',
    objective: 'Set up a space where you can improvise without watching yourself.',
    orientation: 'This does not take talent. It takes a room where nobody can hear you.',
    reflection: 'Where and when could you do this without being overheard? Name the room and the hour.',
    body: [
      { p: 'Keep the setup plain. A recorder, a room where you are truly alone, and space to move. Note the date, hit record, begin.' },
      { p: 'Privacy is the whole trick. If any part of you is managing how this sounds to someone else, you are editing instead of finding, and the good stuff will not come.' },
      { p: 'Record everything and keep it. This method was born on cassette tape, when every reel cost money and shelf space. Your phone holds more than you will ever fill, so stop judging while you create. Judging comes later.' },
      { p: 'Speechcraft cannot do this part for you. This app does not record and does not listen. Use your own phone and a closed door. Bring back whatever you decide to keep.' },
    ] },
  { id: 'ac-waysin', module: 'character', order: 3,
    title: 'Three Ways In',
    requiredReviewer: 'acting-professional',
    objective: 'Start an improv from a fragment, a physical detail or a vocal stance.',
    orientation: 'You do not need a whole character to begin. You need one small piece of one.',
    reflection: 'Write down three fragments of speech you overheard this week. Which one has a person behind it?',
    body: [
      { p: 'First way in: an overheard fragment. Collect scraps of real speech, then repeat one until it wakes up an attitude. One word can carry a whole person. A repeated “sir” can build an entire officious clerk.' },
      { p: 'Second: a physical detail. How someone lights a cigarette. How they hold a bottle. How an old man crosses a room. One honest gesture pulls the rest of the body with it.' },
      { p: 'Third, and strongest: a vocal stance. Not an impression. Let a way of speaking shape the improv from inside. Say something you know by heart in a voice nothing like yours and hear what happens to the words.' },
      { p: 'There is a fourth door too: people who are already performing. A teacher. A preacher. A gym instructor. Someone yelling in the street.' },
    ] },
  { id: 'ac-noaim', module: 'character', order: 4,
    title: 'Do Not Aim',
    requiredReviewer: 'acting-professional',
    objective: 'Improvise without steering toward a result.',
    orientation: 'This fails one way more than any other: trying to make it good while it is happening.',
    reflection: 'Play back something you improvised. Where can you hear yourself trying to be good?',
    body: [
      { p: 'Aim at nothing. Not funny. Not moving. Not clever. Become the person, get into the situation, and see what happens.' },
      { p: 'Do not think about the finished piece yet. It does not matter if the character rambles. Judging while you create kills the creating, and creating is the only job right now.' },
      { p: 'Expect waste. Throw everything at the wall and see what sticks. Three good minutes come out of hours of improv. That ratio is the method working, not you failing.' },
    ] },
  { id: 'ac-transcribe', module: 'character', order: 5,
    title: 'Listen, Transcribe, Go Again',
    requiredReviewer: 'acting-professional',
    objective: 'Turn raw improv into material through a loop you repeat.',
    orientation: 'You are not making a piece yet. You are producing dirt to sift.',
    reflection: 'Read your oldest transcription. Is there someone in it you missed at the time?',
    body: [
      { p: 'Listen back and find the parts you like the sound of. Not the best ideas. The parts that sound like someone. This is sifting: a lot of dirt for a little gold.' },
      { p: 'Write those parts down and keep them. A scrap that reads as nothing in March can start a person in September.' },
      { p: 'Then clean your gold. Work the fragment over, learn it, and use it to launch the next improv. Pocket what you keep and go back for the next batch of dirt. The pile gets richer every pass.' },
      { p: 'Once something is on paper, ask the plain questions. What was this person doing ten minutes ago? What are they wearing? How old are they, and what does that do to the voice? The answers matter less than what they wake up.' },
    ] },
  { id: 'ac-essence', module: 'character', order: 6,
    ...
    body: [
      { p: 'Keep them active. Standing, moving, engaged. Skip the mime and the costume. Both make the audience grade the imitation instead of watching the person.' },
      { p: 'Here is the test. Imagine an audience that does not speak the language. Would they still watch? If it only works when the words land, the character is not doing enough yet.' },
      { p: 'Two last things. Let the character say the opposite of what people expect. Give the worst person in the piece their side of the story. And put on stage what you would most want to see from a seat in the audience.' },
    ] },
  ...
  { id: 'ac-dials', module: 'rhythm', order: 1,
    ...
    orientation: 'Most actors use one word for two different things. Splitting them gives you two controls instead of one.',
    reflection: 'Take a speech you know well. Is the problem the speed, or the pattern inside the speed?',
    body: [
      { p: 'Tempo is how fast. Rhythm is the pattern of long and short inside that speed. They move on their own. You can be fast and smooth, fast and jagged, slow and steady, or slow and broken.' },
      { p: 'The fix depends on which dial is off. Wrong tempo: change the speed. Wrong rhythm: changing the speed just moves the same bad pattern faster. That is why “pick up the pace” so often fixes nothing.' },
      { p: 'Three traps to know by name. Rhythmic body, arhythmic speech, or the reverse. One rhythm for every role, so you are always recognizably you. And perfect metre with nothing underneath it.' },
    ] },
  { id: 'ac-feeling', module: 'rhythm', order: 2,
    title: 'Rhythm Reaches Feeling',
    requiredReviewer: 'acting-professional',
    objective: 'Use tempo-rhythm as a way into feeling.',
    orientation: 'Feeling cannot be ordered around. Speed can. That gap is the whole trick.',
    reflection: 'What circumstance would make your character move at the speed you gave them?',
    body: [
      { p: 'There are three doors into an actor. The text reaches the mind. The objective reaches the will. Tempo-rhythm reaches the feelings, and the feelings answer to nothing else. You cannot tell yourself to dread something. You can set the rhythm and let the dread walk in behind it.' },
      { p: 'It does not work empty. Rhythm with nothing behind it is drumming. Give it a circumstance and the two feed each other: the situation shapes the rhythm, and the rhythm shows you more of the situation.' },
      { p: 'Speed alone tells you nothing. A march, a stroll and a funeral can share one tempo and nothing else. When a rhythm feels arbitrary, find the circumstance that would make it necessary.' },
    ] },
  { id: 'ac-tworhythms', module: 'rhythm', order: 3,
    title: 'Two Rhythms at Once',
    requiredReviewer: 'acting-professional',
    objective: 'Mark an inner and an outer rhythm on the same speech, and play the gap.',
    orientation: 'A person hiding something runs two rhythms at once. The gap between them is what the audience reads.',
    reflection: 'Where in your script is your character calmer outside than inside?',
    body: [
      { p: 'Inside and outside do not have to match. Usually they should not. Someone waiting for bad news sits very still. Someone lying speaks evenly. Quiet surface, racing interior. The performance lives in the distance between them.' },
      { p: 'The two push on each other. The harder you hold the outside steady, the faster the inside runs, which makes the outside harder to hold. That loop is playable. Play it.' },
      { p: 'One mind can split the same way. Resolve against doubt, each at its own speed. When a scene feels flat and everything else is right, you have probably given one rhythm where the moment needs two.' },
    ] },
  { id: 'ac-harmony', module: 'rhythm', order: 4,
    title: 'Harmony, Not Unison',
    requiredReviewer: 'acting-professional',
    objective: 'Hear a scene as separate rhythms sounding together.',
    orientation: 'Two people in the same rhythm are singing in unison. A scene almost never wants that.',
    reflection: 'Are you in harmony with the other character or in unison? If unison, did you choose it?',
    body: [
      { p: 'Everyone has their own rhythm, on stage as in life. A whole group on one rhythm is unison: soldiers, a chorus, a crowd with one urge. There, sameness is the point. A scene is not that. A scene is harmony: different lines sounding at once.' },
      { p: 'A chord needs different notes. Two players on the same note just make it louder. What the audience hears between two characters is the interval, and nobody plays the interval alone. Hold your line and let the space between you do the work.' },
      { p: 'Some intervals sit sweet and some grate. Both are music. Two rhythms that refuse to settle are not a scene going wrong. Watch out for accidental unison: a scene rehearsed until everyone drifts onto one pace. Tidy, and nothing like people.' },
    ] },
  { id: 'ac-rests', module: 'rhythm', order: 5,
    title: 'Notes and Rests',
    requiredReviewer: 'acting-professional',
    objective: 'Treat pauses as part of the rhythm, not gaps in it.',
    orientation: 'Syllables are the notes. Pauses are the rests. A rest is written into the music.',
    reflection: 'Which of your pauses carry something? Which are just waiting?',
    body: [
      { p: 'Speech divides time. Words fill some of it, pauses fill the rest, and both carry rhythm. Long sounds, short sounds, strong stresses, weak ones. That is the whole toolkit, and every rhythm in speech is built from it.' },
      { p: 'The common failure is the dead pause. The silence drops the rhythm, everyone loses the thread, and the line has to restart cold. The fix: keep a silent count running under the pause. The rhythm continues. Only the sound stops.' },
      { p: 'That same count carries you between phrases with different rhythms. Prose mixes them by nature. Do not force one measure onto everything. Keep counting across the join and let it bridge.' },
    ] },
  { id: 'ac-speeds', module: 'rhythm', order: 6,
    title: 'The Two Missing Speeds',
    requiredReviewer: 'acting-professional',
    objective: 'Build true slow speech and true fast speech.',
    orientation: 'Most stage speech is neither slow nor fast. It is long pauses with the words rushed out between them.',
    reflection: 'Can you say your hardest line at half speed without it dying, and at double speed without it turning to mush?',
    body: [
      { p: 'Real slowness is hard because slow goes dead. The words separate, the line stalls, the audience hears the machinery. What keeps a slow line alive is sound, not silence. Let the vowels carry it the whole way through.' },
      { p: 'Real speed is not rushing. It is built from exaggerated slowness. Take the passage far slower than you will ever play it, every consonant finished, and repeat until your mouth knows it without you. Then speed up. Any other route turns to mush right when you most need to be heard.' },
      { p: 'Both speeds need a reason. Slow with no reason is pompous. Fast with no reason is a trick. Circumstance first, speed second. Always.' },
    ] },
];
...
export const ACTING_COLLECTIONS = [
  ...
  { id: 'character', icon: '🧍', title: 'Building a Character',
    lessons: ['ac-inside', 'ac-room', 'ac-waysin', 'ac-noaim',
