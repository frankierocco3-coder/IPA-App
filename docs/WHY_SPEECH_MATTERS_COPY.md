...
## Adjacent copy (also verbatim)

**Grandfathered invite card (Learn):** title "New: Why Speech Matters";
body "A short preface on the power and responsibility of speech. It
takes about three minutes, and your progress is untouched either way."
Buttons: "Read it" / "Not now".

**About section:** heading "Why Speech Matters"; body "The preface — on
